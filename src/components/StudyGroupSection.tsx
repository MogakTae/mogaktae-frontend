...
const StudyGroupSection: React.FC = () => {
    ...
    // 현재 페이지에 표시 카드
    const currentGroups = studyGroups.slice(currentPage * itemsPerPage, (currentPage + 1) * itemsPerPage);
        ...
        <section className="py-16 px-6 bg-white">
            <div className="max-w-6xl mx-auto">
                <div className="flex justify-between items-center mb-8">
                    <h2 className="text-3xl font-bold text-gray-900">모각테 그룹</h2>
                    ...
                    {currentGroups.map((group) => (
                        ...
                        >
                            ...
                            <div className="p-4 text-left">
                                <h3 className="font-semibold text-gray-900 text-lg mb-2 truncate">{group.name}</h3>

                                <p className="text-gray-600 text-sm mb-2">{group.description}</p>

                                <p className="text-gray-500 text-xs">{group.period}</p>
                            </div>
                        </button>
                    ))}
                </div>
